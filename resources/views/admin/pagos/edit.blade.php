<x-layouts::app title="Editar Pago a Empleado">
    <div class="relative mb-6 w-full flex justify-between items-center">
        <div>
            <flux:heading size="xl" level="1">Editar Registro de Pago</flux:heading>
            <flux:subheading>Modifique los datos del sueldo, bonos y descuentos correspondientes.</flux:subheading>
        </div>
        <div>
        ...
        <form action="{{ route('admin.pagos.update', $pago->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    <flux:field>
                        ...
                        <select name="mes" class="w-full rounded-lg border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-gray-800 dark:text-zinc-200 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" required>
                            ...
                            @endphp
                            @foreach ($meses as $m)
                                <option value="{{ $m }}" {{ (old('mes', $pago->mes) == $m) ? 'selected' : '' }}>{{ $m }}</option>
                            @endforeach
                        </select>
                        <flux:error name="mes" />
                    </flux:field>
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="anio" type="number" value="{{ old('anio', $pago->anio) }}" required />
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="fecha_pago" type="date" value="{{ old('fecha_pago', $pago->fecha_pago) }}" required />
                ...
                <div class="md:col-span-2">
                    <flux:field>
                        ...
                        <flux:input name="nro_comprobante" type="text" placeholder="Ej. CMP-00123" value="{{ old('nro_comprobante', $pago->nro_comprobante) }}" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="salario_base" id="salario_base" type="number" step="0.01" min="0" value="{{ old('salario_base', $pago->salario_base) }}" required />
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="bonos" id="bonos" type="number" step="0.01" min="0" value="{{ old('bonos', $pago->bonos) }}" />
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="descuento_afp" id="descuento_afp" type="number" step="0.01" min="0" value="{{ old('descuento_afp', $pago->descuento_afp) }}" />
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="anticipos" id="anticipos" type="number" step="0.01" min="0" value="{{ old('anticipos', $pago->anticipos) }}" />
                ...
                <div>
                    <flux:field>
                        ...
                        <flux:input name="otros_descuentos" id="otros_descuentos" type="number" step="0.01" min="0" value="{{ old('otros_descuentos', $pago->otros_descuentos) }}" />
            ...
            <div class="mb-6">
                <flux:field>
                    ...
                    <textarea name="observaciones" rows="3" class="w-full rounded-lg border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-gray-800 dark:text-zinc-200 p-3 text-sm focus:ring-2 focus:ring-blue-500" placeholder="Observaciones adicionales sobre el pago...">{{ old('observaciones', $pago->observaciones) }}</textarea>
            ...
            <div class="flex justify-end gap-3">
                ...
                <flux:button variant="primary" type="submit" color="blue">Actualizar Pago</flux:button>
            </div>
        </form>
    </div>

    <!-- Script actualizado para mostrar el área y calcular montos en tiempo real -->
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Al cambiar de empleado, se actualiza el área y opcionalmente el salario base
            selectEmpleado.addEventListener('change', function () {
                ...
                const area = selectedOption.getAttribute('data-area') || 'Sin área asignada';
            ...
            // Escuchar cambios de escritura en los campos numéricos
            [inputSalario, inputBonos, inputAfp, inputAnticipos, inputOtros].forEach(input => {
                input.addEventListener('input', calcularTotal);
            });

            // Cargar automáticamente el área del empleado actual al cargar la vista de edición
            ...
            // Ejecutar inmediatamente para mostrar el total inicial basado en los datos de la BD
            calcularTotal();
        });
    </script>
</x-layouts::app>