<x-layouts::app title="Editar Permiso o Vacación">
        ...
        <form action="{{ route('admin.permisos.update', $permiso->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <flux:field>
                    ...
                    <select name="tipo" id="tipo_solicitud" class="w-full rounded-lg border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-gray-700 dark:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <option value="Vacaciones" {{ old('tipo', $permiso->tipo) == 'Vacaciones' ? 'selected' : '' }}>Vacaciones (Ley boliviana)</option>
            ...
            <div>
                <flux:field>
                    ...
                    <textarea name="motivo" rows="3" class="w-full rounded-lg border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 p-3 text-sm text-gray-700 dark:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Detalle el motivo...">{{ old('motivo', $permiso->motivo) }}</textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Cargar al iniciar si ya es Vacaciones
